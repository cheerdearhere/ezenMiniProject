...
<h3 class="text-center">Dash Board(pie)</h3>
<div class="mb-3">
...
<div class="d-flex mb-3 mx-auto pl-5" style="width:40%"><!-- 안내판 -->
	<button class="btn btn-primary" disabled>외부원: pc 판매량</button>
	<button class="btn btn-info" disabled>내부원: 모니터 판매량</button>
</div>
<div>
