...
<form action="bWrite" method="post" id="fwrite">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" id="uname" name="bName" value="${user_id}" required readonly/>
	</div>
	<div class="form-group">
		<label for="title">제목: </label>
		<input type="text" class="form-control" id="title" name="bTitle" required/>
	</div>
	<div class="form-group">
		<label for="content">내용: </label>
		<textarea class="form-control" id="content" name="bContent"rows="10" required></textarea>
	</div>
	<button type="submit" class="btn btn-success">작성</button> &emsp;
	<a href="eBoard" id="writeLink" class="btn btn-primary">목록보기</a>
</form>
